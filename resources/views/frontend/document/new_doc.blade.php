        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">New Documents</div>
            </div>
          </div>
          ...
          <div class="section-body">
            ...
            <p class="section-lead">
              Recently submitted documents awaiting initial approval
            </p>
                        ...
                        <div id="searchCard" class="collapse">
                            <div class="card-body">
                                <form method="GET" action="{{ route('sa_search_documents') }}" class="form-inline" style="margin-top: 10px; flex-wrap: wrap;">
                                    ...
                                    <div class="form-group mr-2 mb-2">
                                        <select name="first_approver" class="form-control">
                                            <option value="">First Approver</option>
                                            <option value="Medical Director" {{ request('first_approver') == 'Medical Director' ? 'selected' : '' }}>Medical Director</option>
                                            <option value="General Manager" {{ request('first_approver') == 'General Manager' ? 'selected' : '' }}>General Manager</option>
                                        </select>
                                    </div>
                                    <div class="form-group mr-2 mb-2">
                                    ...
                                    <div class="form-group mb-2">
                                        <a href="{{ route('new_documents') }}" class="btn btn-secondary">Reset</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($docs as $doc)
                                        ...
                                        <tr data-id="{{ $doc->id }}">
                                            ...
                                            @else
                                                <td>
                                                    <span class="status-badge status-new">{{ $doc->status }}</span>
                                                </td>
                                            @endif                                        
                                            <td>
                                                @if(!empty($approvalSequence))
                                                    ...
                                                    @if($currentApprover && $doc->status != 'Completed' && $doc->status != 'Closed')
                                                        <div class="mt-1">
                                                            <small class="text-warning">
                                                                <i class="fas fa-clock"></i> Pending at: {{ $currentApprover }}
                                                            </small>
                                                        </div>
                                                    @endif
                                                @else
                                                    <!-- Fallback for old documents without approval sequence -->
                                                    <span class="status-badge status-pending">{{ $doc->approval_status ?? 'Pending' }}</span>
                                                @endif
                                            </td>

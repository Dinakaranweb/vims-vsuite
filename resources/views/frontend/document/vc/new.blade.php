...
<style>
    ...
    .status-filter-btn.yet-to-approve {
        border-left-color: #66b2f5ff;
    }
    .status-filter-btn.yet-to-approve.active {
        background-color: #66b2f5ff;
        color: white;
        border-color: #66b2f5ff;
    }
    ...
    <div id="app">
        ...
        <section class="section">
          ...
          <div class="section-body">
            <!-- <h2 class="section-title">Yet to Approve</h2>
            <p class="section-lead">
              Following Documents approved by Registrar and Pro VC, pending for your approval.
            </p> -->

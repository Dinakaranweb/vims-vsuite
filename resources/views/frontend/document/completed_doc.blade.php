    ...
    <div id="app">
        ...
        <section class="section">
          <div class="section-header">
            <h1>Completed/Closed Documents</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin_dashboard') }}">Dashboard</a></div>
              <div class="breadcrumb-item">Completed/Closed Documents</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Completed/Closed Documents</h2>
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        ...
                        <div class="p-3 border-top">
                            <form method="GET" action="{{ route('completed_documents') }}" class="form-row align-items-end">
                                ...
                                <div class="form-group col-md-2 d-flex">
                                    ...
                                    <a href="{{ route('completed_documents') }}" class="btn btn-secondary">Reset</a>
                                </div>
                            </form>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($docs as $doc)
                                        <tr data-id="{{ $doc->id }}">
                                            ...
                                            <td>{{ $doc->doc_id }}</td>
                                            <td>
                                                @if(isset($payments[$doc->id]) && count($payments[$doc->id]) > 0)
                                                    @foreach($payments[$doc->id] as $payment)
                                                        <div>{{ $payment->expenditure_id }}</div>
                                                    @endforeach
                                                @else
                                                    <div>-</div>
                                                @endif
                                            ...
                                            <td>{{ $doc->from }}</td>
                                            <td>
                                                <span class="badge {{ $doc->status == 'Completed' ? 'badge-success' : 'badge-secondary' }}">
                                                    {{ $doc->status }}
                                                </span>
                                            </td>

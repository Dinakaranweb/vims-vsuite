    ...
    <div id="app">
        ...
        <section class="section">
          <div class="section-header">
            <h1>Closed Documents</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin_dashboard') }}">Dashboard</a></div>
              <div class="breadcrumb-item">Closed Documents</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Closed Documents</h2>
                        ...
                        <div id="searchCard" class="collapse">
                            <div class="card-body">
                                <form method="GET" action="{{ route('sa_search_documents') }}" class="form-inline" style="margin-top: 10px;">
                                    ...
                                    <a href="{{ route('closed_documents') }}" class="btn btn-secondary ml-2">Reset</a>
                                </form>
                            </div>
                        </div>
                    </div>

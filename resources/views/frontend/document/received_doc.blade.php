        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">Sent to {{ Auth::user()->department }}</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Sent to {{ Auth::user()->department }}</h2>
                                        ...
                                        <tr id="accordion-{{ $doc->id }}" class="accordion-content" style="display: none;">
                                            <td colspan="4" style="border-right: none">
                                                ...
                                                <div class="accordion-details" style="text-align: left">
                                                    ...
                                                    <!--<p><b>Description :</b> {!! strip_tags(\Illuminate\Support\Str::limit($doc->description, 100, '...'), '<span><b><i><u>') !!}</p>-->
                                                    @if($doc->amount)

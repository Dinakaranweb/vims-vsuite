                        ...
                        <div class="collapse show" id="mycard-collapse">
                          <div class="card-body">
                            <table border="1" style="width:100%">
                              ...
                              <tr style="padding:10px">
                                <th style="padding:15px">Forwarded to</th>
                                <td style="padding:10px">{{ $forwarded->forwarded_to }} Dept</td>
                              </tr>
                              @endif
                              <tr style="padding:10px">
                                ...
                                @else
                                  <td style="padding:10px">
                                    <div class="btn-group">
                                      ...
                                      <div class="dropdown-menu">
                                        <a class="dropdown-item" href="{{ route('change.ticket.status' ,['ticket_status' => 'Open', 'ticket_id' => $ticket->id]) }}">Re-open</a>
                                      </div>
                                    </div>
                                  </td>
                                @endif

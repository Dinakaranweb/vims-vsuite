...
@section('content')
    ...
    <div id="app">
            ...
            <div class="section-body">
              ...
              <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      <form method="POST" action="{{ route('staff_specific_report') }}" class="needs-validation" novalidate="">
                      @csrf  
        ...
        <!-- <a href="{{ url('/chart-template') }}"><button class="btn btn-primary">Download</button></a> -->
         ...
         <form id="chart-form" method="POST" action="{{ route('staff_generate_specific_report') }}">
            @csrf

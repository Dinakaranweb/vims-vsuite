    ...
    <div id="app">
        ...
        <section class="section">
          <div class="section-header">
            <h1>Self Assigned Tickets</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="{{ route('admin_dashboard') }}">Dashboard</a></div>
              <div class="breadcrumb-item"><a href="{{ route('admin_tickets_summary') }}">Tickets Summary</a></div>
              <div class="breadcrumb-item">Self Assigned Tickets</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Self Assigned Tickets</h2>
            <p class="section-lead">
              Unfinished tasks will send a ping to the Department Head automatically.
            </p>
                            ...
                            <tbody> 
                                ...
                                @foreach ($tickets as $ticket)   
                                    <tr data-id="{{ $ticket->id }}">
                                        ...
                                        <td>
                                            <a href="{{ url('admin/view/ticket/'.$ticket->id) }}" class="btn btn-primary btn-action mr-1" data-toggle="tooltip" title="View"><i class="fas fa-solid fa-eye"></i></a>
                                            <div class="btn-group">

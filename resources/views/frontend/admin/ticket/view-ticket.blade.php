                  ...
                  <div class="col-lg-8 col-md-12">
                    ...
                    <div class="tickets" style="display: block;">
                      <div class="ticket-content" style="width:100%">
                        ...
                        @php
                            $doc = \App\Models\DocumentApproval::find($ticket->doc_id);
                            $approval_logs = DB::table('approval_log')->where('doc_id', $doc->id)->latest()->get();
                        @endphp

                              <div class="card">
                                <div class="card-header">
                                  <h4 style="color:red">Approval Request</h4>
                                </div>
                                  <div class="card-body">
                              ...
                              <div class="card">
                                <div class="card-header">
                                  <h4 style="color:red">Approval Status</h4>
                                </div>
                                  <div class="card-body">
                                      <div class="approval-flowchart-container">
                                          <div class="approval-flowchart">

                                              @foreach($approval_logs as $alog)
                                                  @php
                                                      $role = \App\Models\User::FindorFail($alog->by)->department;
                                                      if($role == 'Pro-VC'){
                                                          $style = 'provc';
                                                      }elseif($role == 'VC'){
                                                          $style = 'vc';
                                                  ...
                                                  <div class="step">
                                                      ...
                                                      <div class="{{ $style }}">
                                                          <p>{!! $alog->status !!}</p>
                                                          <hr>
                                                          <span class="description">{!! $alog->message !!}</span>
                                                          <hr>
                                                          <p>{{ date('d/m/Y h:i A', strtotime($alog->created_at)) }}</p>
                                                      </div>
                                                  </div>
                        ...
                        @endif
                        @if($ticket->status != "Closed" && $ticket->assigned_to != Null)
                        <div class="card">
                          <div class="card-body">
                            <div class="ticket-form">
                              <form action="{{ route('ticket-respond') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group text-right">
                                  <a href="{{ route('create_document', ['ticket_id' => $ticket->id]) }}" class="btn btn-dark btn-lg" style="color:#fff; margin-right: 20px;">
                                      Create a Request
                                  </a>
                          ...
                          <div class="card-body">
                            <table border="1" style="width:100%">
                              ...
                              <tr style="padding:10px">
                                ...
                                <td style="padding:10px">{{ $ticket->ticket_to }} Section</td>
                              </tr>
                              @php
                              ...
                              @if($ticket->ticket_by == Auth::id() || $ticket->ticket_from == Auth::user()->department || $ticket->ticket_to != Auth::user()->department)
                                  <tr style="padding:10px">
                                      ...
                                      @if($ticket->assigned_to == null)
                                          <td style="padding:10px">Not yet assigned</td>
                                      @else

        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item"><a href="{{ route('admin_tickets_summary') }}">Tickets</a></div>
              <div class="breadcrumb-item">Dept Tickets</div>
            </div>
          </div>

          <div class="section-body">
            <h2 class="section-title">Dept Tickets</h2>
            <p class="section-lead">
              Tickets created by your department staffs.
            </p>

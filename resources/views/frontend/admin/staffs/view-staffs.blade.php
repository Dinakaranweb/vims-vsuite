                            ...
                            <tbody> 
                                ...
                                @foreach ($staffs as $emp)
                                    <tr data-id="{{ $emp->id }}">
                                        ...
                                        <td>
                                            ...
                                            @else
                                            <a href="{{ route('change-account-status', ['id' => $emp->id]) }}" class="btn btn-icon btn-dark mr-1" data-toggle="tooltip" title="Inactive"><i class="far fa-user"></i></a>
                                            @endif
                                            <a href="{{ route('edit-staff', ['id' => $emp->id]) }}" class="btn btn-warning btn-action mr-1" data-toggle="tooltip" title="Edit"><i class="far fa-edit"></i></a>
                                ...
                                <script>
                                    function handleConfirmYes(empId) {
                                        ...
                                        window.location.href = "{{ route('delete-staff', ['id' => ':id']) }}".replace(':id', empId);
                                    }
                                </script>

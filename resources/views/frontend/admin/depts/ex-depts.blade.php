                            ...
                            <tbody> 
                                ...
                                @foreach ($depts as $emp)
                                    <tr data-id="{{ $emp->id }}">
                                        ...
                                        <td>
                                            <a class="btn btn-info" data-confirm="Are You Sure?|Add this department back?" data-confirm-yes="handleConfirmYes({{ $emp->id }})" style="color:#fff">Recover</a>
                                        </td>
                                    </tr>
                                @endforeach
                                ...
                                <script>
                                    function handleConfirmYes(empId) {
                                        ...
                                        window.location.href = "{{ route('recover-dept', ['id' => ':id']) }}".replace(':id', empId);
                                    }
                                </script>

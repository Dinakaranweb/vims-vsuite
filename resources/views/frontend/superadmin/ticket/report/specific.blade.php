...
@section('content')
    ...
    <div id="app">
            ...
            <div class="section-body">
              ...
              <div class="row">
                <div class="col-12 col-md-12 col-lg-12">
                  <div class="card">
                    <div class="card-body">
                      <form method="POST" action="{{ route('super_admin_specific_dept_ticket_report') }}" class="needs-validation" novalidate="">
                      @csrf  
                        ...
                        <div class="col-lg-5 col-md-5 form-group" style="display: inline-block;">
                          ...
                          <input id="to" type="text" name="to" class="form-control datepicker" value="{{ $to }}">
                        </div>
                                ...
                                @foreach ($tickets as $ticket)   
                                    <tr data-id="{{ $ticket->id }}">
                                        ...
                                        @else
                                            ...
                                            <td>
                                                <a href="#" class="font-weight-600">{{ $user->name }}</a>
                                            </td>
                                        @endif
                                        <td>
        ...
        <!-- <a href="{{ url('/chart-template') }}"><button class="btn btn-primary">Download</button></a> -->
         ...
         <form id="chart-form" method="POST" action="{{ route('super_admin_generate_specific_dept_ticket_report') }}">
            @csrf

    ...
    <div id="app">
        ...
        <div class="main-content">
            ...
            <div class="row">
                ...
                <a href="{{ route('super_admin_open_tickets') }}">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                <a href = "{{ route('super_admin_tickets_in_progress') }}">
                    <div class="card card-statistic-1">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href = "{{ route('super_admin_tickets_on_hold') }}">
                        <div class="card card-statistic-1">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                    <a href = "{{ route('super_admin_completed_tickets') }}">
                        <div class="card card-statistic-1">

                            ...
                            <tbody> 
                                ...
                                @foreach ($staffs as $emp)
                                    <tr data-id="{{ $emp->id }}">
                                        ...
                                        <td>
                                            @if($emp->can_use_api)
                                            <a href="{{ route('super-admin-toggle-api-access', ['id' => $emp->id]) }}" class="btn btn-sm btn-success" data-toggle="tooltip" title="API Enabled — click to disable"><i class="fas fa-mobile-alt"></i> Enabled</a>
                                            @else
                                            <a href="{{ route('super-admin-toggle-api-access', ['id' => $emp->id]) }}" class="btn btn-sm btn-secondary" data-toggle="tooltip" title="API Disabled — click to enable"><i class="fas fa-mobile-alt"></i> Disabled</a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($emp->is_active)

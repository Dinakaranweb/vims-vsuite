...
@section('content')
                        ...
                        <div class="login-card row g-0">
                            ...
                            <div class="col-12 col-lg-5 login-banner">
                                <div>
                                    ...
                                    <h3 class="fw-bold mb-3 text-white d-none d-lg-block">Reset Password</h3>
                            ...
                            <div class="col-12 col-lg-7 login-form-area bg-white">
                                <div class="mb-4">
                                    ...
                                    <p class="text-muted small mb-0">We’ll send a reset link to your email</p>
                                </div>
                                ...
                                <form method="POST" action="{{ route('forget.password.post') }}" class="mb-3" id="forgotForm" novalidate>
                                    @csrf
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 shadow-sm login-btn" id="resetBtn">
                                        <span class="btn-text">Send Reset Link <i class="bi bi-arrow-right ms-1"></i></span>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // ── Submit handling: validate and show loading state ──
            ...
            if (form && resetBtn) {
                form.addEventListener('submit', function (e) {
                    ...
                    // Visual loading state (server-side logic unchanged)

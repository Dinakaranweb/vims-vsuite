...
// Guard: only run on the page that has the myChart canvas element
...
if (myChartEl) {
  new Chart(myChartEl, {
    ...
    options: {
      ...
      scales: {
        y: { grid: { display: false, drawBorder: false }, ticks: { stepSize: 150 } },
        x: { grid: { color: '#fbfbfb', lineWidth: 2 } }
      }
    }
  });
}
...
if (document.getElementById('myWeather')) {
  getWeather();
